...
import com.test.server.dispatch.InitDispatchHandler;
import com.test.server.dispatch.SendTextToServerHandler;
import com.test.shared.dispatch.InitDispatchAction;
import com.test.shared.dispatch.SendTextToServerAction;

/**
 * Module which binds the handlers and configurations.
 */
@Configuration
@Import({DefaultModule.class, PropertyModule.class})
@ImportResource("classpath:META-INF/properties.xml")
@ComponentScan({"com.test", "com.gwtplatform.dispatch.server.spring"})
public class ServerModule extends HandlerModule {
    ...
    protected void configureHandlers() {
    	bindHandler(InitDispatchAction.class, InitDispatchHandler.class);
